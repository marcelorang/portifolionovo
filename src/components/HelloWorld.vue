<template>
  <div>
    <v-tabs v-model="tab" color="deep-purple-accent-4" align-tabs="center">
      <v-tab @click="scrolltoSobre" :value="1">About</v-tab>
      <v-tab @click="scrollFunction" :value="2">Portfólio</v-tab>
      <v-tab @click="scrolltoContact" :value="3">Contact</v-tab>
    </v-tabs>
  </div>
  <v-sheet elevation="6">
    <v-container class="fill-height">
      <v-responsive class="align-center text-center fill-height">
        ...
        <v-row>
          <v-col cols="12" sm="6" lg="2">
            <v-card variant="tonal">
              ...
              <div class="infos">
                <h1 id="scrollToAbout">Marcelo Rangel</h1>
                ...
                <v-row>
                  <v-col>
                    <div>
                      <a href="https://github.com/marcelorang">
                        <svg width="48" height="48" enable-background="new 0 0 512 512" id="Layer_1" version="1.1"
                  ...
                  <v-col>
                    <div>
                      <a href="https://www.linkedin.com/in/marcelo-rangel-622089221/">
                ...
                desenvolvimento de softwares. Buscando oportunidades para
                aplicar sua paixão pela tecnologia e construir soluções
                inovadoras. Determinado a alcançar objetivos e evoluir na
                carreira.
              </h5> -->
              </div>
            </v-card>
              ...
              <v-row align="center" align-content="space-between">
                ...
                <v-col cols="12" lg="6" sm="6">
                  ...
                  <v-sheet>
                    ...
                    Dashboard Admin para clínica Médica, Odontologicas, Etc. Com
        ...
        <v-divider />
        <v-card>
          <div class="text-start pa-4" style="font-size: 20px">
            Formado no curso Superior em Desenvolvimento Web pela faculdade
            Anhanguera,<br />
            Começei no mundo da programação em agosto de 2021, quando estava
            ...
            construir soluções inovadoras, determinado a alcançar objetivos e
            evoluir na carreira.
          </div>
        </v-card>
        ...
        <div id="scrolltoContact">
          <v-footer class="d-flex flex-column">
            ...
            <div class="bg-grey d-flex w-100 align-center px-2">


              <div>
                <v-col>
                  <h2 style="color:black">Contatos</h2>
                  <p style="color:black">+55 81 99686-0815</p>
              ...
              <v-col>
                <div>
                  <a href="https://github.com/marcelorang">
                    <svg width="28" height="28" enable-background="new 0 0 512 512" id="Layer_1" version="1.1"
                      viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink">
                      <g>
                        <circle cx="256" cy="256" fill="#333333" r="256" />
            ...
            <div class="px-4 py-2 bg-black text-center w-100">
              {{ new Date().getFullYear() }} — <strong>Marcelo Rangel</strong>
            </div>
          </v-footer>
        </div>
...
<script>
import img1 from '../assets/images/medzip1.png'
import img2 from '../assets/images/medzip2.png'
...
export default {
  ...
  methods: {
    //scrollfunction
    scrollFunction() {
      const element = document.getElementById("scrollToPortifolio");
      element.scrollIntoView({ behavior: "smooth" });
    },
    scrolltoSobre() {
      const element = document.getElementById("scrollToAbout");
      element.scrollIntoView({ behavior: "smooth" });
    },
    scrolltoContact() {
...
.logos-bg {
  background-image: rgb(123, 165, 166);
}
