  ...
  <v-sheet elevation="6">
    <v-container class="fill-height">
      <v-responsive class="align-center text-center fill-height">
        ...
        <svg data-v-55b2ec53="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1442 163" class="logos-bg" fill="#e4e4e2">
          <path data-v-55b2ec53=""
...
export default {
  data() {
    return {
      ...
      //   },
      //   {
      //     src: "src/assets/images/telaPhone14.jpg",
      //   },
      //   {
      //     src: "src/assets/images/telaPhone15.jpg",
      //   },
      //   {
