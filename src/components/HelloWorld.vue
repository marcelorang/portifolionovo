  ...
  <v-sheet elevation="6">
    <v-container class="fill-height">
      <v-responsive class="align-center text-center fill-height">
        ...
        <v-row>
          <v-col cols="12" sm="6" lg="2">
            <v-card variant="tonal">
              ...
              <div class="infos">
                <h2 id="scrollToAbout">Marcelo Rangel</h2>
                ...
                <br />
                <v-row align="center" align-content="space-be">
                  <v-col>
              ...
              <v-row align="center" align-content="space-between">
                <v-col cols="12" lg="6" sm="6">
                  ...
                  <v-col cols="12" lg="6" sm="6">
                    ...
                    <v-sheet class="text-left">
                      ...
                      Vue, Ionic, Android Stúdio .NET C# <br />
                      Aplicativo Mobile.<br />
                      Colaboração como desenvolvedor FrontEnd.
                    </v-sheet>
                  </v-col>
                ...
                <v-col cols="12" lg="6" sm="6">
                  ...
                  <v-sheet class="text-left ">
                    <h3>
                      Tecnologias:
                    </h3> Vue, Vuetify, C#, .NET. <br />
                    Dashboard administrativo para clínicas médicas, odontologicas, etc. Com
                    pronto sistema de agendamento de consultas, <br />cadastros de
                    pacientes, colaboradores e médicos. <br />
                    Colaboração como desenvolvedor frontEnd.<br />
        ...
        <br />
        <v-card>
          <div class="text-center pa-4" style="font-size: 20px">
        ...
        <div id="scrolltoContact">
          <v-footer>
            <div class=" bg-blue-grey-lighten-5 text-center w-100">
...
export default {
  data() {
    return {
      ...
      animals: ['Column 1', 'Column2', 'Column 3'],
